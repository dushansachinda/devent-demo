...
isolated function updateOrder(string orderId, OrderRequest orderRequest) returns Order|error {
    Order updatedOrder = check pizzaClient->/orders/[orderId].patch(orderRequest);
    return updatedOrder;
}